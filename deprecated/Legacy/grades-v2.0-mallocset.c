...
int main(void){
	...
	char please[] = "Please enter a capital ";
	
	int guar1as = sizeof(guar1a);
	int guar1bs = sizeof(guar1b);
	int guar2as = sizeof(guar2a);
	int need1as = sizeof(need1a);
	int need2as = sizeof(need2a);
	int need2bs = sizeof(need2b);
	printf("%d %d %d %d %d %d\n",guar1as,guar1bs,guar2as,need1as,need2as,need2bs);
